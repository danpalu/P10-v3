  ...
  <div class="wrapper">
    <section id="section-1">
      <div class="section-wrapper">
        ...
        <div class="question">
          <h3>
            Hvad er historien bag din virksomhed/organisation - hvorfor blev den startet og hvad har formet den
            undervejs?
          </h3>
          <label>
          ...
          <div class="question target-group">
            ...
            <div class="scroller" ref="target-group-scroller">
              ...
              <fieldset>
                ...
                >
                <label
                  ><input type="radio" name="Målgruppe personlighed" value="kreativ" />Kreativ og kunstnerisk</label
                >
                <label
                  ><input type="radio" name="Målgruppe personlighed" value="praktisk" />Praktisk og
                  problemløsende</label
                >
                <label
                  ><input type="radio" name="Målgruppe personlighed" value="ambitioes" />Ambitiøs og målrettet</label
                >
                <label
              ...
              <fieldset>
                ...
                <label
                  ><input type="radio" name="Målgruppe udfordringer" value="familietid" />Manglende tid til familieliv
                  og hobbyer</label
                >
                <label
              ...
              <fieldset>
                ...
                >
                <label
                  ><input type="radio" name="Målgruppe købsprioriteter" value="bekvemmelighed" />Bekvemmelighed og
                  hurtig levering</label
                >
                <label
