  ...
  const questionnaire = ref<Questionnaire>({
    ...
    sections: [
      ...
      },
      {
        ...
        questions: [
          newQuestion(6, "Hvad ønsker din virksomhed/organisation at opnå med en ny visuel identitet eller design?", "multiple-choice-question"),
          newQuestion(7, "Hvilke værdier eller følelser ønsker du, at din virksomhed/organisation udstråler?", "branding-card-question"),
          newQuestion(8, "Er der særlige symboler, ikoner eller andet visuelt, der har en særlig betydning for din virksomhed/organisation?", "moodboard-question"),
          newQuestion(9, "Hvilken farve repræsenterer bedst virksomhedens/organisations værdier?", "color-question"),
          newQuestion(10, "Hvor skal virksomhedens/organisationens visuelle identitet bruges eller vises?", "multiple-choice"),
        ],
      },
      {
        id: 3,
